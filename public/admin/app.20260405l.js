...
function renderPhotoCount() {
    ...
    elements.photoCountText.textContent = state.batchMode
        ...
        : `${shownCount} / ${filtered.length} / ${state.photos.length} 张照片`;
}
...
function renderPhotoGallery() {
    ...
    elements.photoGallerySentinel.hidden = visiblePhotos.length >= photos.length || !photos.length;
